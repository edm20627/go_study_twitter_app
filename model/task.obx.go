...
func (task_EntityInfo) AddToModel(model *objectbox.Model) {
	model.Entity("Task", 1, 23388513512697388)
	model.Property("Id", 6, 1, 1155911466705518171)
	model.PropertyFlags(1)
	model.Property("Text", 9, 2, 6944371549919274561)
	model.Property("DateCreated", 6, 3, 110954260350249169)
	model.Property("DateFinished", 6, 4, 5106240080230895665)
	model.EntityLastPropertyId(4, 5106240080230895665)
}
